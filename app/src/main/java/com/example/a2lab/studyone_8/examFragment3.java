...
public class examFragment3 extends Fragment {
    ...
    View myView,dialog_nextview;
    TextView text_question, text_answer;
    AlertDialog dialog_nextcase;

    Button buttoncheck, dialog_buttonnext, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15, b16,close;
    Button btn_deletewords,btn_paragraph;
    boolean hint_delete=true;
    RadioGroup mRadioGroup;
    RadioButton radiobtn1, radiobtn2, radiobtn3, radiobtn4;
    Dialog dialog_paragraph;
    ...
    public void draw(int btn_index, String ci) {//在按鈕中畫OX
        ...
        if (Quesnum[0] == Quesnum[1] && Quesnum[1] == Quesnum[2] && Quesnum[2] == Quesnum[3] && Quesnum[0] == 1)//橫判斷
        {
            ...
            showDialog();
            disableButtons();
        } else if (Quesnum[1] == Quesnum[2] && Quesnum[2] == Quesnum[3] && Quesnum[3] == Quesnum[4] && Quesnum[4] == Quesnum[5] && Quesnum[5] == Quesnum[6]
                && Quesnum[6] == Quesnum[7] && Quesnum[7]== Quesnum[8] && Quesnum[8] == Quesnum[9] && Quesnum[9] == Quesnum[10] && Quesnum[10] == Quesnum[11]
                && Quesnum[11]== Quesnum[12] && Quesnum[12] == Quesnum[13] && Quesnum[13] == Quesnum[14] && Quesnum[14] == Quesnum[15] && Quesnum[15] == Quesnum[16]
                && Quesnum[16]==2) {
...
//        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        ...
        builder.setTitle("Congratulations you finish the test!")
                .setIcon(R.drawable.facebook_like)
                .setMessage("You get core:")
...
//                        getActivity().startActivity(intent);
                        Log.i("next", "main3Activity(dialog) ");
                        dialog.cancel();
                    }
                }).show();
